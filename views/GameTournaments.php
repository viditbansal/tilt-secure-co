...
$fields    = " t.id,t.TournamentName,t.TournamentStatus,t.DateCreated,t.StartDate,t.EndDate,t.TournamentStatus ";
$condition = " ";
$pagingParam	=	'';
$developerId		=	$_SESSION['tilt_developer_id'];
$condition .= "  t.fkDevelopersId = ".$developerId." AND t.Status = 1 ";
if(isset($_GET['viewId']) && $_GET['viewId'] != '' ){
	$condition .= " and t.fkGamesId = ".$_GET['viewId']." " ;
...
$tournamentResult	=	'';
$tot_rec ='';
$tournamentResult  = $reportObj->getGameTournaments($fields,$condition);
...
<body class="popup_bg" style="">
	...
	<section class="content col-md-12 box-center develop_page">
		...
		<div class="search_group">
			<form class="tournament" method="post" action="<?php echo 'GameTournaments'.$pagingParam;?>">
		...
		<div id="pagingResult" class="clear" style="width: 100%">
			<form action="GameTournaments" class="l_form" name="TournamentPlayedUsersList" id="TournamentPlayedUsersList"  method="post"> 
		...
		<div class="col-xs-12 clear">
			<?php if(isset($tournamentResult) && is_array($tournamentResult) && count($tournamentResult) > 0 ) {
				pagingControlLatest($tot_rec,'GameTournaments'.$pagingParam); ?>
			<?php }?>
		</div><br>
		</section>
<?php commonFooter(); ?>
