   ...
   function getTotalRecordCount()
	...
	function insertJsonServiceParamsDetails($values)
	{
		if (!isset($this->ServiceModelObj))
			$this->loadModel('ServiceModel', 'ServiceModelObj');
		if ($this->ServiceModelObj)
			return $this->ServiceModelObj->insertJsonServiceParamsDetails($values);
	}
	/*------APP VERSION-----*/
	function getAppversionList()
	{
		if (!isset($this->ServiceModelObj))
			$this->loadModel('ServiceModel', 'ServiceModelObj');
		if ($this->ServiceModelObj)
			return $this->ServiceModelObj->getAppversionList();
	}
	function checkAppVersionExists($device_type,$app_type,$game_key)
	{
		if (!isset($this->ServiceModelObj))
			$this->loadModel('ServiceModel', 'ServiceModelObj');
		if ($this->ServiceModelObj)
			return $this->ServiceModelObj->checkAppVersionExists($device_type,$app_type,$game_key);
	}
	function addAppversion($postArray)
	{
		if (!isset($this->ServiceModelObj))
			$this->loadModel('ServiceModel', 'ServiceModelObj');
		if ($this->ServiceModelObj)
			return $this->ServiceModelObj->addAppversion($postArray);
	}
	function updateAppversion($postArray,$id)
	{
		if (!isset($this->ServiceModelObj))
			$this->loadModel('ServiceModel', 'ServiceModelObj');
		if ($this->ServiceModelObj)
			return $this->ServiceModelObj->updateAppversion($postArray,$id);
	}
	function deleteAppversion($id)
	{
		if (!isset($this->ServiceModelObj))
			$this->loadModel('ServiceModel', 'ServiceModelObj');
		if ($this->ServiceModelObj)
			return $this->ServiceModelObj->deleteAppversion($id);
	}
}
?>