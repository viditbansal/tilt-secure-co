 ...
 * Copyright (c) 2012 jQuery Foundation and other contributors Licensed MIT */ (function (e, t) {
    function i(t, n) {
...
(function (e, t) {
    ...
    e.widget("ui.autocomplete", {
        ...
        _create: function () {
			...
			,this.menu = e("<b>").addClass("ui-autocomplete").addClass("ui-autocomplete-input").appendTo(this.document.find(this.options.appendTo || "body")[0])
