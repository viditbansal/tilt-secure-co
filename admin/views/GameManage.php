			...
			if(isset($insert_id)	&&	$insert_id!='')	{
				...
				if(isset($_POST['iOnOff']) && $_POST['iOnOff'] == 1){ //iOS details given
					if($insertios_pnid != ''){ //Update old
						...
						if(isset($_POST['ios_arn'])	&&	$_POST['ios_arn']!='')
							$pn_fields .= "ARNKey =  '".$_POST['ios_arn']."',";
						$pn_fields .= 	"Status 				 =	1,
				...
				if(isset($_POST['aOnOff']) && $_POST['aOnOff'] == 1){ //Only push Android in on status
					if($insertandroid_pnid != ''){ //Update old
						...
						if(isset($_POST['arn'])	&&	$_POST['arn']!='')
							$pn_fields .= "ARNKey =  '".$_POST['arn']."',";
						$pn_fields .= 	"Status  =	1,
									DateModified =	'".date('Y-m-d H:i:s')."'";
									...
									<table cellpadding="0" cellspacing="0" align="center" border="0" width="80%">
										...
										<tr>
											...
											<td align="left"  height="40"  valign="top">
												...
												<input type="radio" class="" name="aOnOff" id="aOn" onchange="changeNotification(2)" value="1" <?php  if($androidswitch == 1) echo 'Checked';  ?>>
											...
											<td colspan="6">
												<table width="100%" id="iosNotif" style="<?php if($iosswitch != 1) echo "display:none" ; ?>">
													...
													<tr>
														...
														<td  align="center" valign="top">:</td>
														<td align="left"  height="60" valign="top">
															<input type="password" name="ios_password" id="ios_password" class="input" maxlength="255" placeholder="<?php if(isset($ios_password) && $ios_password == 1 ) { echo 'Overwrite old password';} else {echo 'Your Certificate Password (leave empty for no password)';} ?>" value="" autocomplete="off" ondrop="return false;" onpaste="return false;">
														</td>
														<?php if($devFlag) { ?>
														<td height="50" align="left"  valign="top"><label>ARN Key</label></td>
														<td align="center"  valign="top">:</td>
														<td align="left"  height="40"  valign="top">
															<input type="text" name="ios_arn" id="ios_arn" value="<?php if(isset($iosarn_key) && $iosarn_key !='' ) echo $iosarn_key; ?>" maxlength="150"  class="input" />
														</td>
														<?php } ?>
													</tr>
												</table>
												...
												<table width="100%" align="center" id="andNotif" style="<?php if($androidswitch != 1)  echo "display:none" ; ?>">
													<tr>
													 ...
													 <tr>
														...
														<td align="center"  valign="top">:</td>
														<td align="left"  height="40"  valign="top">
															<input type="text" name="arn" id="arn" value="<?php if(isset($arn_key) && $arn_key !='' ) echo $arn_key; ?>" maxlength="150" class="input" />
														</td>
														<?php } ?>
													</tr>
												</table>
...
function changeNotification(type){
	if($("#iOff").is(":Checked") && $("#aOff").is(":Checked")){
		alert('Either iOS or Android must be in On status');
		if(type == 1)
